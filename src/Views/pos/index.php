...
<div id="view-pos" class="view-section">
    ...
    <?php if ($erreur !== null): ?>
        ...
        <div class="panel-card"
             style="margin-bottom: 16px; border-left: 4px solid var(--danger); color: var(--danger);">
    ...
    <?php if ($commandeCreeeId !== null): ?>

        <div class="panel-card"
             style="margin-bottom: 16px; border-left: 4px solid var(--success); color: var(--success);">

            Commande #<?= $commandeCreeeId ?> créée avec succès.
    ...
    <div style="display: grid; grid-template-columns: 600px 1fr; gap: 32px; align-items: start; margin-bottom: 32px;">
        ...
        <div class="panel-card"
                ...
                <div style="display: grid; grid-template-columns: 1fr 90px 38px; gap: 10px; align-items: end; margin-bottom: 16px;">
                    ...
                    >
                        ...
                        <select
                            ...
                            id="produit_id"
                            class="form-control"
                            style="background-color: #0b0f1a; padding: 10px; font-size: 12px;"
                            required
                        >
                            ...
                            <?php foreach ($produits as $produit): ?>
                                ...
                                <option
                                    ...
                                    data-name="<?= htmlspecialchars($produit->getNom(), ENT_QUOTES, 'UTF-8') ?>"
                                    data-stock="<?= $stock ?>"
                                >
            ...
            <!-- Panier courant -->
            <table class="debt-table"
                   style="font-size: 11px; margin-top: 16px;">
            ...
            <form method="POST">
                ...
                <div style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.08) 0%, rgba(30, 41, 59, 0.4) 100%); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 16px; padding: 14px; text-align: center; margin: 16px 0; box-shadow: inset 0 0 15px rgba(59, 130, 246, 0.08);">

                    <span style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700; letter-spacing: 1px; display: block; margin-bottom: 4px;">
                        Montant Total Net à Payer
                    </span>

                    <div style="font-size: 24px; font-weight: 900; color: #60a5fa; letter-spacing: -0.5px; font-family: monospace;">
                ...
                <button
                    ...
                    style="padding: 14px; font-weight: 800; font-size: 13px; width: 100%;"
                    <?= $panier === [] ? 'disabled' : '' ?>
                >
                ...
                <tbody>
                    ...
                    <?php if ($ventes === []): ?>
                        ...
                        <tr>
                            ...
                            <td
                                colspan="5"
                                style="text-align: center; color: var(--text-muted); padding: 16px 0;"
                            >
